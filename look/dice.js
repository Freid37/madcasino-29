...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-eda503af');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-eda503af');}
...
var brandEl=document.querySelector('.rl-brand-eda503af');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
